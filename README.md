...
-	[`3.0-dev10`, `3.0`](https://github.com/haproxytech/haproxy-docker-alpine/blob/main/3.0/Dockerfile)
-	[`2.9.7`, `2.9`, `latest`](https://github.com/haproxytech/haproxy-docker-alpine/blob/main/2.9/Dockerfile)
-	[`2.8.9`, `2.8`](https://github.com/haproxytech/haproxy-docker-alpine/blob/main/2.8/Dockerfile)
-	[`2.7.12`, `2.7`](https://github.com/haproxytech/haproxy-docker-alpine/blob/main/2.7/Dockerfile)
-	[`2.6.17`, `2.6`](https://github.com/haproxytech/haproxy-docker-alpine/blob/main/2.6/Dockerfile)
-	[`2.4.26`, `2.4`](https://github.com/haproxytech/haproxy-docker-alpine/blob/main/2.4/Dockerfile)
-	[`2.2.33`, `2.2`](https://github.com/haproxytech/haproxy-docker-alpine/blob/main/2.2/Dockerfile)
-	[`2.0.35`, `2.0`](https://github.com/haproxytech/haproxy-docker-alpine/blob/main/2.0/Dockerfile)
...
```console
$ docker run -d --name my-running-haproxy -v /path/to/etc/haproxy:/usr/local/etc/haproxy:ro haproxytech/haproxy-alpine:2.7
```
