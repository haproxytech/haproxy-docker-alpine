...
-\t[`2.1-dev1`, `2.1`](https://github.com/haproxytech/haproxy-docker-alpine/blob/master/2.1/Dockerfile)
-\t[`2.0.7`, `2.0`, `latest`](https://github.com/haproxytech/haproxy-docker-alpine/blob/master/2.0/Dockerfile)
-\t[`1.9.11`, `1.9`](https://github.com/haproxytech/haproxy-docker-alpine/blob/master/1.9/Dockerfile)
-\t[`1.8.21`, `1.8`](https://github.com/haproxytech/haproxy-docker-alpine/blob/master/1.8/Dockerfile)
-\t[`1.7.11`, `1.7`](https://github.com/haproxytech/haproxy-docker-alpine/blob/master/1.7/Dockerfile)
-\t[`1.6.14`, `1.6`](https://github.com/haproxytech/haproxy-docker-alpine/blob/master/1.6/Dockerfile)
